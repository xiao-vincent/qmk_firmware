...
//my custom binds
//#define L_DUAL_SHIFT MT(MOD_LSFT, KC_F)
//#define L_DUAL_ALT MT(MOD_LALT, KC_D)
//#define L_DUAL_GUI MT(MOD_LGUI, KC_F)
//
////#define R_DUAL_SHIFT MT(MOD_LSFT, KC_F)
//#define R_DUAL_ALT MT(MOD_RALT, KC_O)
//#define R_DUAL_GUI MT(MOD_LGUI, KC_I)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |Ctrl|Ctrl|Alt |        Space          |Alt| FN|Ctrl|Lef|Dow|Rig |
   * `----------------------------------------------------------------'
   */
[_BL] = LAYOUT_ansi(
